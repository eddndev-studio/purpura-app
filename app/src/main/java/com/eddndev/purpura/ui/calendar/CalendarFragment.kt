...
// resuelve la navegacion al Detalle y el menu de heatmap; el estado vive en CalendarViewModel y la UI
// en CalendarScreen. Pinta la rejilla del mes con puntos por tipo y, debajo, la lista de eventos del
// dia seleccionado.
@AndroidEntryPoint
